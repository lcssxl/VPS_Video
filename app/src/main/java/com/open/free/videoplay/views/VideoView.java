package com.open.free.videoplay.views;
...
import com.open.free.videoplay.utils.Player;
import com.open.free.videoplay.utils.TimeUtils;
...
public class VideoView extends Activity implements Runnable {
    ...
    private void initData() {
        ...
        player = new Player(context, surfaceView, skbProgress, playIcon,
                videoProgressBar, videoUrl);
        ...
        manager.listen(new MobliePhoneStateListener(), PhoneStateListener.LISTEN_CALL_STATE);
    }
    ...
    class SeekBarChangeEvent implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            playCurplase.setText(
                    TimeUtils.changeToTimeStr(player.mediaPlayer.getCurrentPosition())
                    + "/"
                    + TimeUtils.changeToTimeStr(player.mediaPlayer.getDuration()));
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            //根据进度条进度，调整视频播放进度
            player.mediaPlayer.seekTo(progress, -1);
        }
    }
